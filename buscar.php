...
$grupos = $_POST['grupos'];
  ...
  p.Descripcion as 'PRODUCTO', p.NoBasico as 'BASICO', e.existencia as 'EXISTENCIA', e.disponible as 'DISPONIBLE', 
            CASE  
            ...
            WHERE p.PLUEmpresa = 2 AND p.Descripcion LIKE '%$descripcion%' AND g.Nombre LIKE '%$grupos%' AND g.Nombre <> 'VARIOS'
